...
replacements = [
    ...
    ('onboard-certificates.zh.html', 'onboard-certificates.en.html', 4),
    ('onboard-certificates.en.html', 'onboard-certificates.zh.html', 2),
    ...
    ('<a href="../index.zh.html">← 海事筆記</a>', '<a href="../index.en.html">← Maritime Notes</a>'),
    ('<a href="../../index.zh.html">首頁</a>', '<a href="../../index.html">Home</a>'),
    ('<a href="../../about.zh.html">關於我</a>', '<a href="../../about.en.html">About</a>'),
    ('<a href="../../research/index.zh.html">管理筆記</a>', '<a href="../../research/index.en.html">Management Notes</a>'),
    ...
    ('<a href="onboard-certificates.zh.html" lang="zh-Hant" hreflang="zh-Hant" aria-current="true">繁中</a>',
     '<a href="onboard-certificates.zh.html" lang="zh-Hant" hreflang="zh-Hant">繁中</a>'),
    ('<h1>船上應攜帶證書與文件清單</h1>',
